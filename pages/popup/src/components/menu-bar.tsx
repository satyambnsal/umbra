...
export const MenuBarBase = ({ leftSlot, children, rightSlot }: MenuBarBaseProps) => {
  return (
...
export const MenuBar = ({
  ...
  switch (variant) {
    case 'dashboard':
      return (
        <MenuBarBase leftSlot={<LogoButton onClick={goHome} />} rightSlot={<MenuDrawer />}>
        ...
        <MenuBarBase
          ...
          rightSlot={
            <div className="flex space-x-2">
              <div className="tooltip tooltip-secondary tooltip-bottom" data-tip="Network management">
                <Link to="/" type="button" className="flex flex-col btn min-h-10 h-10" onClick={onNetworkClicked}>
              ...
              <button type="button" className="btn btn-circle min-h-10 h-10 w-10" onClick={onCloseClicked}>
    ...
    case 'back':
      return (
        <MenuBarBase
          leftSlot={
            <button type="button" className="btn btn-circle min-h-10 h-10 w-10" onClick={onBackClicked}>
